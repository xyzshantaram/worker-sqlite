...
throw new Error('worker-sqlite currently doesn\'t work with sqlite3, due to issues with running in a Worker. If anyone has any tips on this, feel free to open a GitHub issue.');
